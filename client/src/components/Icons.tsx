...
export function SoundIcon({ className = base }: IconProps) {
  return (
...
export function BrainIcon({ className = base }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M12 5a3 3 0 0 0-5.99.14A3 3 0 0 0 4 11a3 3 0 0 0 1 5.83A3 3 0 0 0 12 19Z" />
      <path d="M12 5a3 3 0 0 1 5.99.14A3 3 0 0 1 20 11a3 3 0 0 1-1 5.83A3 3 0 0 1 12 19Z" />
    </svg>
  );
}
