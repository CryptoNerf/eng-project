        ...
        {result !== null ? (
          <div>
            ...
            <p className="mt-3 text-sm leading-relaxed text-ink-600">
              Теперь «готовность к видео» считается по вашему уровню, а не по
              усреднённому. Проценты на колодах могут заметно измениться — это
              и есть правда о том, сколько речи вы понимаете.
            </p>
            <button
